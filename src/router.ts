...
import registerRouter from "./features/hackathon-register/hackathon-register.routes";
import submissionRouter from "./features/manage-submission/submission.route";
...
router.use("/hackathons", registerRouter);
router.use("/hackathons", submissionRouter);
